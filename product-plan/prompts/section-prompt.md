...
- **SECTION_NAME** = [Human-readable name, e.g., "AI-Powered City Vision" or "Contact & Engagement"]
- **SECTION_ID** = [Folder name in sections/, e.g., "ai-powered-city-vision" or "contact-engagement"]
